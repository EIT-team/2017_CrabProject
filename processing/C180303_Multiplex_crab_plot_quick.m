...
%Cuffs (All Channels, 1-9, Stimulating on hooks) 
...
% Fc = 225;
% This is Required, if there is no EIT, so then detected Fc = 49.99 Hz. 
...
% F6dB1=Fc-BW;
% F6dB2=Fc+BW;
% FiltBP = designfilt('bandpassiir', ...       % Response type
%     'FilterOrder',N, ...            % Filter order
%     'HalfPowerFrequency1',F6dB1, ...    % Frequency constraints
%     'HalfPowerFrequency2',F6dB2, ...
%     'DesignMethod','Butter', ...         % Design method
