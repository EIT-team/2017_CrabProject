...
% change file names
%remove bad repeats, or make it the right number - the variable Y needs to be 58
bad_trigs = 1:2 ; % if it breaks make this line 1:3
...
strsplit(HDR.FileName,'\') ;
%This splits the HDR.FileName into pieces based on the \

a = strsplit(HDR.FileName ,'\') ;
%This assigns the a variable to a cell with each of hte 4 parts. 

filesavea = strcat(a{7}) ;
%Inside the {} indicates which 'section' of the brackets it is looking for. I.e. how
%many folders deep is the relevant part? 

strsplit(filesavea,'.vhdr') ;

b = strsplit(filesavea ,'.vhdr') ;

filesaveb = strcat(b{1}) ;

save(filesaveb , 'Out' , 'Chns_used' , 'EP_all' , 'Fc' , 'Fc_est' , 'T' , 'bad_chn' , 'bad_trigs' , 'bath_chn' , 'dV_all' , 'good_chn' , 'iChn' , 'inj_chn' , 'tau' , 'tau_max' , 'BV') ; 
%save(strcat(a{4},'.mat')) ;
%This saves the workspace with the name of the 4th part of the string split 
