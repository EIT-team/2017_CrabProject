function [Tp,mdV,sdV,dPhi,Xinj]=inj_elec_analysis_phase(Nerve_number, EIT_number, Pair_number, Inj, y1, y2)
%
...
hasTrig = find(any(abs(TrigData(T>-2 & T<2,:))>5e3));
...
[Tp,mdV,sdV,dPhi]=sub_demod_phase(Xinj,Fc,tstr);
