...
for i=[7:24]
    ...
    oo=10;
    %if(i>=11) oo=19;end;
    [T,mdV1,sdV,dphi_curr,Curr]=inj_elec_analysis_phase(30,i,p,[7,17],[-2e3,7e3],[-0.1,0.1]);
    
    [T,mdV,sdV,dphi_volt,Volt]=inj_elec_analysis_phase(30,i,p,[4,9],[-2e3,7e3],[-0.1,0.1]);  
